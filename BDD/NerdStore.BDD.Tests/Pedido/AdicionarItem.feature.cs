...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("pt-BR"), "Pedido", "Pedido - Adicionar Item Ao Carrinho", "\tComo Um Usuario\r\n\tEu desejo colocar um item no carrinho\r\n\tPara que eu possa comp" +
                    "ra-lo posteriormente", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 12
testRunner.And("O Valor Total Do Pedido Sera Exatamente O Valor do Item Adicionado", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "E ");
#line hidden
            }
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Adicionar Item Ja Presente no carrinho")]
        [Xunit.TraitAttribute("FeatureTitle", "Pedido - Adicionar Item Ao Carrinho")]
        [Xunit.TraitAttribute("Description", "Adicionar Item Ja Presente no carrinho")]
        public void AdicionarItemJaPresenteNoCarrinho()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Adicionar Item Ja Presente no carrinho", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 21
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 25
testRunner.And("O mesmo produto ja tenha sido adicionado no carrinho anteriormente", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "E ");
#line hidden
#line 26
testRunner.When("O usuario adicionar uma unidade ao carrinho", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Quando ");
#line hidden
...
#line hidden
#line 28
testRunner.And("A quantidade de items daquele produto tera sido acrescida em uma unidade a mais", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "E ");
#line hidden
#line 29
testRunner.And("O valor total do pedido sera a multiplicacao da quantidade de itens pelo valor un" +
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Adicionar Item Ja Existente onde soma ultrapassa limite maximo")]
        [Xunit.TraitAttribute("FeatureTitle", "Pedido - Adicionar Item Ao Carrinho")]
        [Xunit.TraitAttribute("Description", "Adicionar Item Ja Existente onde soma ultrapassa limite maximo")]
        public void AdicionarItemJaExistenteOndeSomaUltrapassaLimiteMaximo()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Adicionar Item Ja Existente onde soma ultrapassa limite maximo", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 31
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
